...
\begin{eqnarray}\label{eq:ODE2}
 ...
 \frac{3}{2}T(r)\nabla\cdot\Gamma =  \frac{P_{ext,T}}{N}f(r) -  [E_{ion_2}\langle\sigma v\rangle_{ion_2}(T) + \frac{3}{2}T(r)\langle\sigma v\rangle_{rec}(T) + E_{rad}^i\langle\sigma v\rangle_{rad}^i(T)]n(r)^2 \nonumber \\ - [E_{ion}\langle\sigma v\rangle_{ion}(T)+ E_{rad}^0\langle\sigma v\rangle_{rad}^0(T)]n_0n(r) - \varpi\frac{n^2(r)}{T^{1/2}(r)}\ln\left[\alpha \frac{T^{3/2}(r)}{n^{1/2}(r)}\right]\label{eq:EnergyEq}
\end{eqnarray}
